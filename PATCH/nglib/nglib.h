...
////// begin seren
DLL_HEADER int Ng_CSG_Test(const char* filename);
...
int My_Ng_GetElement_Faces (Ng_Mesh *mesh_, int elnr, int * faces, 
				int * orient, bool update);
int My_Ng_GetFace_Vertices (Ng_Mesh *mesh_, int fnr, int * vert);
DLL_HEADER int GetBoundaryID(Ng_Mesh *mesh_, int id);
DLL_HEADER void SetBoundaryID(Ng_Mesh *mesh_, int id, int sn);
DLL_HEADER Ng_Result Ng_CSG_ProjectPoint (const char * filename, double coord[3], int geoid);
void My_Ng_UpdateTopology(Ng_Mesh *mesh_);
DLL_HEADER int GetDomIn(Ng_Mesh *mesh, int id);
DLL_HEADER int SetDomIn(Ng_Mesh *mesh, int id, int did);
DLL_HEADER int GetDomOut(Ng_Mesh *mesh, int id);
DLL_HEADER int SetDomOut(Ng_Mesh *mesh, int id, int did);
...
#ifdef OCCGEOMETRY
DLL_HEADER Ng_Result Ng_OCC_GenerateMesh (Ng_OCC_Geometry *occgeom, Ng_Mesh * ngmesh, Ng_Meshing_Parameters * mp, 
...
#endif
DLL_HEADER Ng_Result Ng_STL_ProjectPoint (Ng_STL_Geometry * geom, Ng_Mesh* mesh, double *x);
